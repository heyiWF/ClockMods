...
public final class WidgetRemoteViewsFactory {
     ...
     * variants (sans, serif, monospace); the rest use the stable resource order in
     * {@link WidgetFontRegistry#COLUMNS}. Every column is generated from the
    ...
    private static final int[] WEATHER_TALL_LAYOUTS={R.layout.widget_weather_tall,R.layout.widget_weather_tall_serif,R.layout.widget_weather_tall_mono,R.layout.widget_weather_tall_roboto,R.layout.widget_weather_tall_gsansdisplay,R.layout.widget_weather_tall_gsanstext,R.layout.widget_weather_tall_sfprodisplay,R.layout.widget_weather_tall_sfprorounded,R.layout.widget_weather_tall_inter,R.layout.widget_weather_tall_lato,R.layout.widget_weather_tall_lora,R.layout.widget_weather_tall_notosans,R.layout.widget_weather_tall_bitcount};

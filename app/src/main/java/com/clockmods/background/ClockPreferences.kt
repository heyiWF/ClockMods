...
open class ClockPreferences(context: Context) {
    ...
    fun getDateFontScale(): Float = clampDateScale(preferences.getFloat(KEY_DATE_FONT_SCALE, DEFAULT_DATE_FONT_SCALE))
    fun setDateFontScale(value: Float) { preferences.edit().putFloat(KEY_DATE_FONT_SCALE, clampDateScale(value)).apply() }
    ...
    fun getChimeAnimation(): String = normalizeChimeAnimation(preferences.getString(KEY_CHIME_ANIMATION, CHIME_RADIAL))
    fun setChimeAnimation(value: String?) { preferences.edit().putString(KEY_CHIME_ANIMATION, normalizeChimeAnimation(value)).apply() }
    ...
    fun getDateFontScale(scopeId: String?): Float = clampDateScale(preferences.getFloat(KEY_DATE_FONT_SCALE_PREFIX + normalizeScope(scopeId), getDateFontScale()))
    fun setDateFontScale(scopeId: String?, value: Float) { preferences.edit().putFloat(KEY_DATE_FONT_SCALE_PREFIX + normalizeScope(scopeId), clampDateScale(value)).apply() }
    ...
    fun restoreDefaults() {
        ...
        editor.putString(KEY_BACKGROUND_MODE, MODE_COLOR).putInt(KEY_BACKGROUND_COLOR, DEFAULT_BACKGROUND_COLOR)
            ...
            .putBoolean(KEY_HALF_HOUR_CHIME, DEFAULT_HALF_HOUR_CHIME).putString(KEY_CHIME_ANIMATION, CHIME_RADIAL).putBoolean(KEY_HOURLY_CHIME_QUIET, DEFAULT_HOURLY_CHIME_QUIET)
    ...
    companion object {
        ...
        const val CHIME_RADIAL = "radial"; const val CHIME_RIPPLE = "ripple"; const val CHIME_PULSE = "pulse"
        const val CHIME_AURORA = "aurora"; const val CHIME_ORBIT = "orbit"; const val CHIME_COMET = "comet"
        private const val KEY_CHIME_ANIMATION = "chime_animation"
        ...
        @JvmStatic fun normalizeChimeAnimation(value: String?): String = when (value) {
            CHIME_RIPPLE, CHIME_PULSE, CHIME_AURORA, CHIME_ORBIT, CHIME_COMET -> value
            else -> CHIME_RADIAL
        }
        ...
        private fun clampDateScale(value: Float): Float = if (value.isNaN() || value.isInfinite()) DEFAULT_DATE_FONT_SCALE else value.coerceIn(MIN_FONT_SCALE, MAX_DATE_FONT_SCALE)
